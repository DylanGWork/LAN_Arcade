...
SERVER_MAP=${MINDUSTRY_MAP:-Ancient_Caldera}
SERVER_MODE=${MINDUSTRY_MODE:-survival}
JAVA_XMS=${MINDUSTRY_XMS:-128m}
JAVA_XMX=${MINDUSTRY_XMX:-512m}
SERVER_COMMANDS="config name $SERVER_NAME,config desc $SERVER_DESC,config port $SERVER_PORT,host $SERVER_MAP $SERVER_MODE"
