...
BATCH_THREE = [
    ...
    {
        "id": "pioneers-lan", "download_slug": "pioneers", "title": "Pioneers LAN Hub", "short_title": "Pioneers", "icon": "CATAN", "meta": "Native Board Game - Settlers-like", "description": "No-internet play-smoked Catan-like table with local server, AI opponents, cached Debian packages, and LAN hosting notes.", "tags": "Board Game,Strategy,Native", "categories": "board-game,strategy,multiplayer,family,casual,age-10-plus", "eyebrow": "Native board-game intake",
        ...
        "facts": ["Catan-like", "Local server", "AI opponents", "No-internet smoke passed"], "source": "https://pio.sourceforge.net/", "packages": ["pioneers", "pioneers-console", "pioneers-data"],
        ...
        "cards": [["Why play", "This gives the LAN Arcade a slower social strategy game that does not require 3D hardware or twitch skill."], ["Offline proof", "A no-internet smoke started a local server with three AI players and connected a GUI client to the board."], ["Next proof", "Run a two-real-client LAN table before calling the multiplayer experience fully exercised."]],
        "steps": [["Build settlements", "Use resource rolls to build roads, settlements, cities, and development cards."], ["Trade smart", "Trades can be better than waiting for perfect dice."], ["Block rivals", "Road placement and settlement positions shape the whole board."], ["LAN proof", "Three-AI server smoke passed; the next gate is two real LAN clients."]],
        "status": [["Downloads", "Debian package set cached"], ["Service", "Local server + AI smoke passed"], ["Client launch", "Passed under no-internet namespace"], ["Next gate", "Two real LAN clients"]],
    },
    {
