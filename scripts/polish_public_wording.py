...
TEXT_REPLACEMENTS = [
    ...
    ("Official mirror/manual", "Offline website/manual"),
    ("Official site/manual mirror", "Offline website/manual"),
    ("Local docs mirror", "Offline manuals and guides"),
    ("Open the mirror", "Open the offline website"),
    ("Open official mirror", "Open offline website"),
    ("Open docs", "Open guides"),
    ("Original source", "Source notes"),
    ("Open upstream", "Open local source notes"),
    ("Source and licensing", "Source notes and licensing"),
    ("source website/manual", "official website/manual"),
    ("mirrored official site/manual", "saved official site/manual"),
    ("mirrored official site", "saved official site"),
    ("source-ready", "ready to play"),
    ("Source-ready", "Ready to play"),
...
REGEX_REPLACEMENTS = [
    ...
    (re.compile(r"<p>Open the locally cached official site/manual or blocker note\.</p>"), "<p>Open the saved official website, manual, or setup note.</p>"),
    (re.compile(r"<p>The official (?:website/wiki|docs) mirror did not complete\."), "<p>The offline website/manual copy is not ready yet."),
