...
const GAME_RECIPES = {
  ...
  'evolab': [
    { type: 'wait', ms: 1400 },
    { type: 'click-text', text: 'Skip' },
    { type: 'wait', ms: 400 },
    { type: 'click-text', text: 'New Game' },
    { type: 'wait', ms: 600 },
    { type: 'click-text', text: 'Start Simulation' },
    { type: 'wait', ms: 1200 },
    { type: 'click-text', text: 'Show Stats' },
    { type: 'keys', keys: ['w', 'd', 's', 'a', 'ArrowUp', 'ArrowRight', 'ArrowDown', 'ArrowLeft'] },
    { type: 'wait', ms: 1800 },
  ],
  'gene-garden': [
    { type: 'game-call', method: 'pause' },
    { type: 'game-call', method: 'setTool', args: ['grass'] },
    { type: 'game-call', method: 'clickCell', args: [18, 14] },
    { type: 'game-call', method: 'setTool', args: ['wall'] },
    { type: 'game-call', method: 'clickCell', args: [30, 21] },
    { type: 'game-call', method: 'setTool', args: ['add'] },
    { type: 'game-call', method: 'clickCell', args: [32, 22] },
    { type: 'game-call', method: 'run' },
    { type: 'wait', ms: 1000 },
    { type: 'game-call', method: 'storm' },
    { type: 'game-call', method: 'fastForward', args: [900] },
    { type: 'wait', ms: 900 },
  ],
  'life-engine': [
    { type: 'wait', ms: 1800 },
    { type: 'game-call', method: 'lifeEngineFastForward' },
    { type: 'wait', ms: 2200 },
    { type: 'game-call', method: 'lifeEngineOpenStats' },
    { type: 'wait', ms: 900 },
  ],
  hextris: [
