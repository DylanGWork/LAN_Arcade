...
declare -A GAMES=(
  ...
  ["airaki-gb"]="LOCAL_DIR::local-games/airaki-gb"
...
declare -A GAME_INFO=(
  ...
  ["airaki-gb"]="Airaki|AIR|Retro - Game Boy Puzzle RPG|Official Homebrew Hub ROM for Airaki, a puzzle/RPG-style Game Boy homebrew.|Retro,RPG,Puzzle"
...
declare -A GAME_CATEGORIES=(
  ...
  ["airaki-gb"]="retro,rpg,puzzle,age-10-plus"
