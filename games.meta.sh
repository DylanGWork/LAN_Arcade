...
declare -A GAME_INFO=(
  ...
  ["pioneers-lan"]="Pioneers|CATAN|Native Board Game - Settlers-like|Offline Pioneers hub with Debian package set, Settlers-of-Catan-style rules, server notes, and LAN table proof path.|Strategy,Board Game,Native"
...
declare -A GAME_CATEGORIES=(
  ...
  ["pioneers-lan"]="strategy,multiplayer,family,casual,age-10-plus"
